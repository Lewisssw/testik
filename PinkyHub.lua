local OrionLib = loadstring(game:HttpGet('https://raw.githubusercontent.com/parmeniss/testtt/main/Protected%20(5).lua'))()
...
local Window = OrionLib:MakeWindow({Name = "Pet Simulator X! | Pinky", HidePremium = false, SaveConfig = true, IntroText = "⭐ PinkBoy - ScriptHub 🐶"})
